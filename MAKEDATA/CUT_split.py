...
def split(input_folder, target_folder, test_data, train = 0.8, val = 0.2):
    ...
    for type in AB:
        ...
        # test_data = [elm for elm in all_data if elm.split(".")[0] in test_data_list] # USEFULE FOR CYCLEE
        ...
        #     shutil.copy(os.path.join(input_folder, type, elm), os.path.join(target_folder, f"test{type}", elm))      # USEFULE FOR CYCLEE   
