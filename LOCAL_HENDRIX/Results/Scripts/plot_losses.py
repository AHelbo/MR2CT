...
def plot_log_p2p(file_path, root_folder):
    ...
    plot_graph(axs, 0, "G loss", "Train", epochs, means[:, 1], line_color = "blue")
    plot_graph(axs, 0, "G loss", "Val", epochs, means[:, 5], line_color = "orange")
    
    plot_graph(axs, 1, "L1 loss", "Train", epochs, means[:, 2], line_color = "blue")
    plot_graph(axs, 1, "L1 loss", "Val", epochs, means[:, 6], line_color = "orange")
    
    plot_graph(axs, 2, "D loss", "D real", epochs, means[:, 3], line_color = "green")
    plot_graph(axs, 2, "D loss", "D fake", epochs, means[:, 4], line_color = "blue")
    
    plot_graph(axs, 3, "SSIM", "Val", epochs, means[:, 7], line_color = "orange")
    
    plot_graph(axs, 4, "PSNR", "Val", epochs, means[:, 8], line_color = "orange")
...
def plot_graph(ax, ax_index, plot_title, plot_label, x_vals, y_vals, line_color = "blue"):
