...
#Run training steps
python3 train.py --dataroot ./datasets/mr2ct_pix2pix_nc3 --name pix2pix_nc3_lowlr --model pix2pix --display_id -1 --load_size 266 --input_nc 3 --output_nc 1 --n_epochs 2500 --D_update_freq 3
