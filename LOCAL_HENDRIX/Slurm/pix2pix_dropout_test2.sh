...
#Run training steps
python train.py --dataroot ./datasets/mr2ct_pix2pix_nc1 --name pix2pix_dropout2 --model pix2pix --display_id -1 --load_size 266 --input_nc 1 --output_nc 1 --n_epochs 50 --no_dropout
