...
python3 train.py --dataroot ./datasets/mr2ct_pix2pix_nc3 --name mr2ct_pix2pix_nc3_f10 --model pix2pix --display_id -1 --load_size 266 --input_nc 3 --output_nc 1 --n_epochs 2500 --batch_size 32 --D_update_frequency 10