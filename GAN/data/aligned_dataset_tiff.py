...
class AlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # img_tiff = tifffile.imread(AB_path)
        # img_8bit = (img_tiff * 255).astype(np.uint8)
        # AB = Image.fromarray(img_8bit)
        ...
        # img_tiff = tifffile.imread(val_AB_path)
        # img_8bit = (img_tiff * 255).astype(np.uint8)
        # val_AB = Image.fromarray(img_8bit)        
