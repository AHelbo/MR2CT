...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--states_dir', type=str, default='states', help='models are saved here')
        # model parameters
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='paired', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | paired]')
